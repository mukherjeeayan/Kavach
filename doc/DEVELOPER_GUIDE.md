...
backend/
  ...
  db/migrations/    # SQL migrations (001-009, auto-applied by docker compose)
...
app/                # Android (Jetpack Compose)
  src/main/java/com/safeguard/parentalcontrol/
...
7. Update openapi.yaml and doc/API.md
